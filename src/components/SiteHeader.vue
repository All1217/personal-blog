    ...
    <div class="page-wrap site-header__inner">
      ...
      <div class="toggles">
        <button type="button" class="icon-btn"
          ...
          :title="locale === 'zh' ? t('actions.localeToEn') : t('actions.localeToZh')" @click="toggleLocale">
          {{ locale === 'zh' ? 'EN' : '中' }}
        </button>
        <button type="button" class="icon-btn"
          :aria-label="theme === 'dark' ? t('actions.themeToLight') : t('actions.themeToDark')"
          :title="theme === 'dark' ? t('actions.themeToLight') : t('actions.themeToDark')" @click="toggleTheme">
          ...
          <svg v-else viewBox="0 0 24 24" aria-hidden="true">
            <path d="M21 14.5A8.5 8.5 0 1 1 9.5 3 7 7 0 0 0 21 14.5z" fill="none" stroke="currentColor" stroke-width="2"
